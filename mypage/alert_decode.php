 ...
 * Date: 2015/4/8
 * Time: 10:23
 * 用于解码baigosso返回的alert代码信息
 */

class alert_decode {
    var $key_value;
    function alert_decode() {
    ...
    function decode($ciphercode) {
//        return $this.$key_value[$ciphercode];
//        return $this.key_value[$ciphercode];
//        $string =  $this.test['test'];
//        $plaintext = $this.test;
//        $f = $plaintext['test'];
        $code_array = $this.key_value;
        return $code_array[$ciphercode];
    }
} 